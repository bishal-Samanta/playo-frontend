   ...
   //Uncoat api blog before using it 
...
//     }
   ...
   //let link = `https://gnews.io/api/v4/top-headlines?topic=sports&lang=en&country=in&token=${apiKey_blog}`
...
//Api call for health news start==================>
    ...
    document.querySelector("#health-news").addEventListener("click", ()=>{
        ...
        let apiKey_health = "6189e46b9c2ae56cb80794edbe24b7c1";
        let bloglink_health = `https://gnews.io/api/v4/top-headlines?topic=health&lang=en&country=in&token=${apiKey_health}`;
...
//Search Feature in news api start================================>
    ...
    document.querySelector("#search").addEventListener('keypress' , (event)=>{
        ...
        console.log("test")
        let search_key = "6189e46b9c2ae56cb80794edbe24b7c1";
        let search_link = `https://gnews.io/api/v4/search?q=${value}&lang=en&country=in&token=${search_key}`;
      
        //https://gnews.io/api/v4/search?q=${value}&lang=en&country=in&token=${search_key}    
        fetch(search_link)
        .then((res)=>{
            return res.json();
        })
